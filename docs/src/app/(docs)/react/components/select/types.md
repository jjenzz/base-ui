...
| defaultValue         | `Value[] \| Readonly<Value> \| Value \| null`                                               | -       | The uncontrolled value of the select when it's initially rendered. To render a controlled select, use the `value` prop instead.                                                                                                                                                                                                                                                                                                                   |
| value                | `Value[] \| Readonly<Value> \| Value \| null`                                               | -       | The value of the select. Use when controlled.                                                                                                                                                                                                                                                                                                                                                                                                     |
